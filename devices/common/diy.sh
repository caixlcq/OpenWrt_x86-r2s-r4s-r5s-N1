...
sed -i "/DISTRIB_DESCRIPTION/c\DISTRIB_DESCRIPTION=\"%D %C by colin'\"" package/base-files/files/etc/openwrt_release
...
sed -i "s/192.168.1/192.168.123/" package/base-files/files/bin/config_generate
